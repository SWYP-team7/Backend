...
public class ConversationController {
	...
	@GetMapping("/me")
	public ResponseEntity<ApiResponse<ConversationResponse.Conversations>> getMyConversations() {
		ConversationResponse.Conversations response = conversationService.findConversations();
		return ResponseEntity.ok(ApiResponse.success(response));
	}
